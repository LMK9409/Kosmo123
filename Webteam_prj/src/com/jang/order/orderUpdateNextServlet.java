...
/**
 * Servlet implementation class orderUpdateNextServlet
 */
@WebServlet("/orderUpdateNextServlet")
public class orderUpdateNextServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public orderUpdateNextServlet() {
        super();
